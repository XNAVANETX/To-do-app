...
## [DEMO APP](https://react-cool-todo-app.netlify.app/)
...
- **🎨 Color Themes**: Users can choose several app color themes. <br/> 
- **🗃️ Multi-Task Selection**: Option to select multiple tasks and perform actions on all of them at once. <br/> 
